...
public abstract class p {
    ...
    public static final ThreadLocal f6610a = new ThreadLocal();

    /* renamed from: b  reason: collision with root package name */
    public static final WeakHashMap f6611b = new WeakHashMap(0);

    /* renamed from: c  reason: collision with root package name */
    public static final Object f6612c = new Object();

    public static void a(l lVar, int i5, ColorStateList colorStateList, Resources.Theme theme) {
        synchronized (f6612c) {
            WeakHashMap weakHashMap = f6611b;
            SparseArray sparseArray = (SparseArray) weakHashMap.get(lVar);
            if (sparseArray == null) {
                sparseArray = new SparseArray();
                weakHashMap.put(lVar, sparseArray);
            }
            sparseArray.append(i5, new k(colorStateList, lVar.f6602a.getConfiguration(), theme));
        }
    }
    ...
    public static Typeface b(Context context, int i5) {
        ...
        return c(context, i5, new TypedValue(), 0, (h0) null, false, false);
    }
    ...
    public static android.graphics.Typeface c(android.content.Context r15, int r16, android.util.TypedValue r17, int r18, a2.h0 r19, boolean r20, boolean r21) {
        /*
            r10 = r16
            r0 = r17
            r7 = r18
        ...
        L_0x002a:
            ...
            k.e r9 = w.h.f6702b
            java.lang.String r1 = w.h.b(r8, r10, r13, r1, r7)
        ...
        L_0x0045:
            ...
            v.e r2 = z1.y.n(r1, r8)     // Catch:{ XmlPullParserException -> 0x007a, IOException -> 0x0078 }
        ...
        L_0x0066:
            ...
            r8 = r19
            r9 = r20
            android.graphics.Typeface r1 = w.h.a(r1, r2, r3, r4, r5, r6, r7, r8, r9)     // Catch:{ XmlPullParserException -> 0x007a, IOException -> 0x0078 }
            goto L_0x00b1
        L_0x0078:
            r0 = move-exception
            goto L_0x00a0
        ...
        L_0x007c:
            ...
            r3.b r1 = w.h.f6701a     // Catch:{ XmlPullParserException -> 0x007a, IOException -> 0x0078 }
            r2 = r15
            r3 = r8
            r4 = r16
            r5 = r13
            r6 = r18
            android.graphics.Typeface r1 = r1.f(r2, r3, r4, r5, r6)     // Catch:{ XmlPullParserException -> 0x007a, IOException -> 0x0078 }
            if (r1 == 0) goto L_0x0094
            java.lang.String r0 = w.h.b(r8, r10, r13, r0, r7)     // Catch:{ XmlPullParserException -> 0x007a, IOException -> 0x0078 }
        ...
        L_0x00d6:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: v.p.c(android.content.Context, int, android.util.TypedValue, int, a2.h0, boolean, boolean):android.graphics.Typeface");
    }
}
