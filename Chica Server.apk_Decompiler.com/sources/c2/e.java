...
public abstract class e extends a implements List, RandomAccess {
    ...
    public static final c f2165b = new c(g.f2181e, 0);

    public static g k(int i5, Object[] objArr) {
        return i5 == 0 ? g.f2181e : new g(i5, objArr);
    }
    ...
    public e subList(int i5, int i6) {
        ...
        return i7 == 0 ? g.f2181e : new d(this, i5, i7);
    }
    ...
    public final c listIterator(int i5) {
        int size = size();
        if (i5 < 0 || i5 > size) {
            throw new IndexOutOfBoundsException(n.t(i5, size, "index"));
        } else if (isEmpty()) {
            return f2165b;
        } else {
