...
public abstract class j5 {
    ...
    public static final int[] f167a = {R.attr.colorPrimary};

    /* renamed from: b  reason: collision with root package name */
    public static final int[] f168b = {R.attr.colorPrimaryVariant};

    public static void a(Context context, AttributeSet attributeSet, int i5, int i6) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.A, i5, i6);
        boolean z5 = obtainStyledAttributes.getBoolean(1, false);
        obtainStyledAttributes.recycle();
        if (z5) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(R.attr.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context, f168b, "Theme.MaterialComponents");
            }
        }
        c(context, f167a, "Theme.AppCompat");
    }
    ...
    public static void b(android.content.Context r4, android.util.AttributeSet r5, int[] r6, int r7, int r8, int... r9) {
        ...
        L_0x003e:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: a2.j5.b(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
