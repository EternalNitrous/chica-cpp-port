...
public abstract class d2 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public d2(View view) {
        ...
        this.f724d = (float) ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f725e = tapTimeout;
        this.f726f = (ViewConfiguration.getLongPressTimeout() + tapTimeout) / 2;
    }

    public final void a() {
        c2 c2Var = this.f729i;
        View view = this.f727g;
        if (c2Var != null) {
            view.removeCallbacks(c2Var);
        }
        c2 c2Var2 = this.f728h;
        if (c2Var2 != null) {
            view.removeCallbacks(c2Var2);
        }
    }
    ...
    public final boolean onTouch(android.view.View r13, android.view.MotionEvent r14) {
        /*
            r12 = this;
            boolean r13 = r12.f730j
            r0 = 3
            android.view.View r1 = r12.f727g
            r2 = 1
            r3 = 0
            ...
            goto L_0x005d
        L_0x0016:
            androidx.appcompat.widget.a2 r4 = r4.f()
            if (r4 == 0) goto L_0x005d
        ...
        L_0x00d2:
            ...
            r12.f731k = r14
            androidx.appcompat.widget.c2 r14 = r12.f728h
            if (r14 != 0) goto L_0x00e3
            androidx.appcompat.widget.c2 r14 = new androidx.appcompat.widget.c2
            r14.<init>(r12, r3)
            r12.f728h = r14
        L_0x00e3:
            androidx.appcompat.widget.c2 r14 = r12.f728h
            ...
            androidx.appcompat.widget.c2 r14 = r12.f729i
        ...
        L_0x0127:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.d2.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    public final void onViewDetachedFromWindow(View view) {
        ...
        c2 c2Var = this.f728h;
        if (c2Var != null) {
            this.f727g.removeCallbacks(c2Var);
        }
    }
}
