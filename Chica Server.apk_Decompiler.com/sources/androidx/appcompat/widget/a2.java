...
public class a2 extends ListView {

    /* renamed from: d  reason: collision with root package name */
    public final Rect f686d = new Rect();
    ...
    public a2(Context context, boolean z5) {
    ...
    public final boolean b(android.view.MotionEvent r17, int r18) {
        ...
        L_0x0035:
            ...
            float r6 = (float) r6
            r1.f694m = r4
            androidx.appcompat.widget.v1.a(r1, r7, r6)
        ...
        L_0x006c:
            ...
            float r11 = (float) r11
            float r11 = r6 - r11
            androidx.appcompat.widget.v1.a(r10, r0, r11)
        ...
        L_0x0098:
            ...
            android.graphics.Rect r5 = r1.f686d
            ...
            boolean r0 = androidx.appcompat.widget.x1.a(r16)
            goto L_0x00e3
        L_0x00d4:
            java.lang.reflect.Field r0 = androidx.appcompat.widget.z1.f1057a
        ...
        L_0x00e3:
            ...
            androidx.appcompat.widget.x1.b(r1, r0)
            goto L_0x0104
        L_0x00f4:
            java.lang.reflect.Field r13 = androidx.appcompat.widget.z1.f1057a
        ...
        L_0x0123:
            ...
            x.b.e(r0, r7, r6)
        L_0x012e:
            androidx.appcompat.widget.y1 r0 = r1.f692j
        ...
        L_0x0185:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.a2.b(android.view.MotionEvent, int):boolean");
    }

    public final void dispatchDraw(Canvas canvas) {
        Drawable selector;
        Rect rect = this.f686d;
    ...
    public final void drawableStateChanged() {
        if (this.f696o == null) {
            ...
            if (selector != null && this.f694m && isPressed()) {
    ...
    public final boolean isInTouchMode() {
        return (this.l && this.f693k) || super.isInTouchMode();
    }
    ...
    public boolean onHoverEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 10 && this.f696o == null) {
            e eVar = new e(2, this);
            this.f696o = eVar;
            post(eVar);
        }
            ...
            if (!(pointToPosition == -1 || pointToPosition == getSelectedItemPosition())) {
                ...
                if (childAt.isEnabled()) {
                    ...
                    if (i5 < 30 || !w1.f1019d) {
                        ...
                        try {
                            w1.f1016a.invoke(this, new Object[]{Integer.valueOf(pointToPosition), childAt, Boolean.FALSE, -1, -1});
                            w1.f1017b.invoke(this, new Object[]{Integer.valueOf(pointToPosition)});
                            w1.f1018c.invoke(this, new Object[]{Integer.valueOf(pointToPosition)});
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f691i = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        e eVar = this.f696o;
        if (eVar != null) {
            a2 a2Var = (a2) eVar.f475b;
            a2Var.f696o = null;
            a2Var.removeCallbacks(eVar);
        }
    ...
    public void setSelector(Drawable drawable) {
        y1 y1Var = drawable != null ? new y1(drawable) : null;
        this.f692j = y1Var;
        super.setSelector(y1Var);
        Rect rect = new Rect();
        if (drawable != null) {
            drawable.getPadding(rect);
        }
        this.f687e = rect.left;
        this.f688f = rect.top;
        this.f689g = rect.right;
        this.f690h = rect.bottom;
    }
}
