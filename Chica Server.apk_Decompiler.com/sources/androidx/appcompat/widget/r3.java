...
public final class r3 extends TouchDelegate {
    ...
    public r3(Rect rect, Rect rect2, SearchView.SearchAutoComplete searchAutoComplete) {
        super(rect, searchAutoComplete);
        int scaledTouchSlop = ViewConfiguration.get(searchAutoComplete.getContext()).getScaledTouchSlop();
        this.f946e = scaledTouchSlop;
        Rect rect3 = new Rect();
        this.f943b = rect3;
        Rect rect4 = new Rect();
        this.f945d = rect4;
    ...
    public final boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        L_0x0041:
            ...
            android.graphics.Rect r4 = r8.f944c
            android.view.View r5 = r8.f942a
