...
public abstract class f2 extends ViewGroup {
    ...
    public f2(Context context, AttributeSet attributeSet, int i5) {
        super(context, attributeSet, i5);
        int[] iArr = a.f2037n;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i5, 0);
        n3 n3Var = new n3(context, obtainStyledAttributes);
        t0.k(this, context, iArr, attributeSet, obtainStyledAttributes, i5);
        int h5 = n3Var.h(1, -1);
        if (h5 >= 0) {
            setOrientation(h5);
        }
        ...
        boolean a6 = n3Var.a(2, true);
        if (!a6) {
            setBaselineAligned(a6);
        }
        this.f775j = obtainStyledAttributes.getFloat(4, -1.0f);
        this.f770e = n3Var.h(3, -1);
        this.f776k = n3Var.a(7, false);
        setDividerDrawable(n3Var.e(5));
        this.f781q = n3Var.h(8, 0);
        this.f782r = n3Var.d(6, 0);
        n3Var.o();
    }
    ...
    public final void f(Canvas canvas, int i5) {
        this.f778n.setBounds(getPaddingLeft() + this.f782r, i5, (getWidth() - getPaddingRight()) - this.f782r, this.f780p + i5);
        this.f778n.draw(canvas);
    }

    public final void g(Canvas canvas, int i5) {
        this.f778n.setBounds(i5, getPaddingTop() + this.f782r, this.f779o + i5, (getHeight() - getPaddingBottom()) - this.f782r);
        this.f778n.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i6) {
            ...
            if (baseline != -1) {
                int i7 = this.f771f;
                if (this.f772g == 1 && (i5 = this.f773h & 112) != 48) {
                    if (i5 == 16) {
                        i7 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f774i) / 2;
                    } else if (i5 == 80) {
                        i7 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f774i;
                    }
                }
                return i7 + ((e2) childAt.getLayoutParams()).topMargin + baseline;
            } else if (this.f770e == 0) {
                return -1;
            } else {
    ...
    /* renamed from: i */
    public e2 generateLayoutParams(AttributeSet attributeSet) {
    ...
    public final boolean k(int i5) {
        if (i5 == 0) {
            return (this.f781q & 1) != 0;
        }
        if (i5 == getChildCount()) {
            return (this.f781q & 4) != 0;
        }
        if ((this.f781q & 2) == 0) {
            return false;
        }
        ...
        if (this.f778n != null) {
            ...
            if (this.f772g == 1) {
                ...
                while (i10 < virtualChildCount) {
                    ...
                    if (!(childAt == null || childAt.getVisibility() == 8 || !k(i10))) {
                        f(canvas, (childAt.getTop() - ((e2) childAt.getLayoutParams()).topMargin) - this.f780p);
                    }
                    i10++;
                }
                if (k(virtualChildCount)) {
                    ...
                    if (childAt2 == null) {
                        i9 = (getHeight() - getPaddingBottom()) - this.f780p;
                    } else {
                        i9 = childAt2.getBottom() + ((e2) childAt2.getLayoutParams()).bottomMargin;
                    }
                    f(canvas, i9);
                    return;
                }
            ...
            while (i10 < virtualChildCount2) {
                ...
                if (!(childAt3 == null || childAt3.getVisibility() == 8 || !k(i10))) {
                    e2 e2Var = (e2) childAt3.getLayoutParams();
                    if (a6) {
                        i8 = childAt3.getRight() + e2Var.rightMargin;
                    } else {
                        i8 = (childAt3.getLeft() - e2Var.leftMargin) - this.f779o;
                    }
                    g(canvas, i8);
                }
                i10++;
            ...
            if (k(virtualChildCount2)) {
                ...
                if (childAt4 != null) {
                    e2 e2Var2 = (e2) childAt4.getLayoutParams();
                    if (a6) {
                        i7 = childAt4.getLeft();
                        i6 = e2Var2.leftMargin;
                    } else {
                        i5 = childAt4.getRight() + e2Var2.rightMargin;
                        g(canvas, i5);
                    }
                } else if (a6) {
                    i5 = getPaddingLeft();
    ...
    public void onLayout(boolean r26, int r27, int r28, int r29, int r30) {
        ...
        L_0x0059:
            ...
            r4 = r16
            androidx.appcompat.widget.e2 r4 = (androidx.appcompat.widget.e2) r4
            int r8 = r4.gravity
            if (r8 >= 0) goto L_0x0074
            r8 = r6
        L_0x0074:
            java.util.WeakHashMap r17 = d0.t0.f4002a
            int r7 = d0.d0.d(r25)
        ...
        L_0x00b3:
            ...
            goto L_0x004e
        L_0x00b9:
            boolean r1 = androidx.appcompat.widget.l4.a(r25)
            ...
            boolean r11 = r0.f769d
            int[] r12 = r0.l
            int[] r13 = r0.f777m
            java.util.WeakHashMap r14 = d0.t0.f4002a
            int r14 = d0.d0.d(r25)
        ...
        L_0x012d:
            ...
            r14 = r22
            androidx.appcompat.widget.e2 r14 = (androidx.appcompat.widget.e2) r14
            r28 = r1
        ...
        L_0x01d1:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.f2.onLayout(boolean, int, int, int, int):void");
    }
    ...
    public void onMeasure(int r39, int r40) {
        ...
        L_0x0068:
            ...
            r5 = r4
            androidx.appcompat.widget.e2 r5 = (androidx.appcompat.widget.e2) r5
            float r4 = r5.weight
            float r22 = r22 + r4
        ...
        L_0x022b:
            ...
            androidx.appcompat.widget.e2 r11 = (androidx.appcompat.widget.e2) r11
        ...
        L_0x026f:
            ...
            androidx.appcompat.widget.e2 r12 = (androidx.appcompat.widget.e2) r12
        ...
        L_0x041c:
            ...
            r2 = r0
            androidx.appcompat.widget.e2 r2 = (androidx.appcompat.widget.e2) r2
            float r0 = r2.weight
            float r29 = r1 + r0
            r1 = 1073741824(0x40000000, float:2.0)
        ...
        L_0x061a:
            ...
            androidx.appcompat.widget.e2 r0 = (androidx.appcompat.widget.e2) r0
        ...
        L_0x068e:
            ...
            androidx.appcompat.widget.e2 r3 = (androidx.appcompat.widget.e2) r3
            float r3 = r3.weight
            r8 = 0
        ...
        L_0x08cb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.f2.onMeasure(int, int):void");
    }
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable != this.f778n) {
            this.f778n = drawable;
            boolean z5 = false;
            if (drawable != null) {
                this.f779o = drawable.getIntrinsicWidth();
                this.f780p = drawable.getIntrinsicHeight();
            } else {
                this.f779o = 0;
                this.f780p = 0;
            }
    ...
    public void setVerticalGravity(int i5) {
        ...
        int i7 = this.f773h;
        if ((i7 & 112) != i6) {
            this.f773h = i6 | (i7 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f3) {
        this.f775j = Math.max(0.0f, f3);
    }
