...
public final class t3 extends b implements View.OnClickListener {
    ...
    public final LayoutInflater f966m;

    /* renamed from: n  reason: collision with root package name */
    public final SearchView f967n;

    /* renamed from: o  reason: collision with root package name */
    public final SearchableInfo f968o;

    /* renamed from: p  reason: collision with root package name */
    public final Context f969p;

    /* renamed from: q  reason: collision with root package name */
    public final WeakHashMap f970q;
    ...
    public t3(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap weakHashMap) {
        ...
        this.f965k = suggestionRowLayout;
        this.f966m = (LayoutInflater) context.getSystemService("layout_inflater");
        this.f967n = searchView;
        this.f968o = searchableInfo;
        this.f971r = searchView.getSuggestionCommitIconResId();
        this.f969p = context;
        this.f970q = weakHashMap;
    }
    ...
    public final void a(android.view.View r22, android.database.Cursor r23) {
        /*
            ...
            r3 = r0
            androidx.appcompat.widget.s3 r3 = (androidx.appcompat.widget.s3) r3
            int r0 = r1.f979z
            r4 = 0
            r5 = -1
        ...
        L_0x0017:
            r6 = r4
        L_0x0018:
            android.widget.TextView r7 = r3.f955a
        ...
        L_0x0061:
            ...
            r17 = 0
            r18 = 0
            android.content.res.ColorStateList r14 = r1.f973t
            r19 = 0
            r20 = r14
            r14 = r15
            r8 = r15
        ...
        L_0x00b5:
            r0.setVisibility(r8)
        L_0x00b8:
            android.widget.ImageView r12 = r3.f957c
        ...
        L_0x0189:
            int r0 = r1.f972s
            android.widget.ImageView r2 = r3.f959e
            r3 = 2
    ...
    public final void b(Cursor cursor) {
        try {
            super.b(cursor);
            if (cursor != null) {
                this.f974u = cursor.getColumnIndex("suggest_text_1");
                this.f975v = cursor.getColumnIndex("suggest_text_2");
                this.f976w = cursor.getColumnIndex("suggest_text_2_url");
                this.f977x = cursor.getColumnIndex("suggest_icon_1");
                this.f978y = cursor.getColumnIndex("suggest_icon_2");
                this.f979z = cursor.getColumnIndex("suggest_flags");
            }
        } catch (Exception e5) {
    ...
    public final String c(Cursor cursor) {
        ...
        SearchableInfo searchableInfo = this.f968o;
        if (searchableInfo.shouldRewriteQueryFromData() && (h6 = h(cursor, cursor.getColumnIndex("suggest_intent_data"))) != null) {
            return h6;
        }
        if (!searchableInfo.shouldRewriteQueryFromText() || (h5 = h(cursor, cursor.getColumnIndex("suggest_text_1"))) == null) {
            return null;
        }
        return h5;
    }
    ...
    public final View d(ViewGroup viewGroup) {
        View inflate = this.f966m.inflate(this.f965k, viewGroup, false);
        inflate.setTag(new s3(inflate));
        ((ImageView) inflate.findViewById(R.id.edit_query)).setImageResource(this.f971r);
        return inflate;
    }
    ...
    public final Drawable e(Uri uri) {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f969p.getPackageManager().getResourcesForApplication(authority);
    ...
    public final android.graphics.drawable.Drawable f(java.lang.String r11) {
        /*
            r10 = this;
            java.util.WeakHashMap r0 = r10.f970q
            java.lang.String r1 = "SuggestionsAdapter"
            android.content.Context r2 = r10.f969p
        ...
        L_0x0045:
            ...
            return r6
        L_0x0048:
            java.lang.Object r6 = t.e.f6484a     // Catch:{ NumberFormatException -> 0x0062, NotFoundException -> 0x0058 }
            android.graphics.drawable.Drawable r5 = u.b.b(r2, r5)     // Catch:{ NumberFormatException -> 0x0062, NotFoundException -> 0x0058 }
    ...
    public final Cursor g(SearchableInfo searchableInfo, String str) {
        ...
        return this.f969p.getContentResolver().query(build, (String[]) null, suggestSelection, strArr, (String) null);
    }
    ...
    public final View getDropDownView(int i5, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.f966m.inflate(this.l, viewGroup, false);
            if (inflate != null) {
                ((s3) inflate.getTag()).f955a.setText(e5.toString());
            }
            return inflate;
        }
    }
    ...
    public final View getView(int i5, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e5);
            View d2 = d(viewGroup);
            ((s3) d2.getTag()).f955a.setText(e5.toString());
            return d2;
        }
    }
