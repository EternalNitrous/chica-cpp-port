...
public class b0 extends ImageButton {
    ...
    public final boolean hasOverlappingRendering() {
        if (!(!(((ImageView) this.f702e.f711e).getBackground() instanceof RippleDrawable)) || !super.hasOverlappingRendering()) {
            return false;
        }
        return true;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        c0 c0Var = this.f702e;
        if (!(c0Var == null || drawable == null || this.f703f)) {
