...
public abstract /* synthetic */ class j {
    ...
    static {
        /*
            ...
            f1511b = r0
            r1 = 1
            androidx.lifecycle.k r2 = androidx.lifecycle.k.ON_CREATE     // Catch:{ NoSuchFieldError -> 0x0012 }
            int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
            r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
        L_0x0012:
            r0 = 2
            int[] r2 = f1511b     // Catch:{ NoSuchFieldError -> 0x001d }
            androidx.lifecycle.k r3 = androidx.lifecycle.k.ON_STOP     // Catch:{ NoSuchFieldError -> 0x001d }
            int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
            r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x001d }
        L_0x001d:
            r2 = 3
            int[] r3 = f1511b     // Catch:{ NoSuchFieldError -> 0x0028 }
            androidx.lifecycle.k r4 = androidx.lifecycle.k.ON_START     // Catch:{ NoSuchFieldError -> 0x0028 }
            int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
            r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
        L_0x0028:
            r3 = 4
            int[] r4 = f1511b     // Catch:{ NoSuchFieldError -> 0x0033 }
            androidx.lifecycle.k r5 = androidx.lifecycle.k.ON_PAUSE     // Catch:{ NoSuchFieldError -> 0x0033 }
            int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
            r4[r5] = r3     // Catch:{ NoSuchFieldError -> 0x0033 }
        L_0x0033:
            r4 = 5
            int[] r5 = f1511b     // Catch:{ NoSuchFieldError -> 0x003e }
            androidx.lifecycle.k r6 = androidx.lifecycle.k.ON_RESUME     // Catch:{ NoSuchFieldError -> 0x003e }
            int r6 = r6.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
            r5[r6] = r4     // Catch:{ NoSuchFieldError -> 0x003e }
        L_0x003e:
            int[] r5 = f1511b     // Catch:{ NoSuchFieldError -> 0x0049 }
            androidx.lifecycle.k r6 = androidx.lifecycle.k.ON_DESTROY     // Catch:{ NoSuchFieldError -> 0x0049 }
            int r6 = r6.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
            r7 = 6
            r5[r6] = r7     // Catch:{ NoSuchFieldError -> 0x0049 }
        L_0x0049:
            int[] r5 = f1511b     // Catch:{ NoSuchFieldError -> 0x0054 }
            androidx.lifecycle.k r6 = androidx.lifecycle.k.ON_ANY     // Catch:{ NoSuchFieldError -> 0x0054 }
            int r6 = r6.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
            r7 = 7
            r5[r6] = r7     // Catch:{ NoSuchFieldError -> 0x0054 }
        L_0x0054:
            androidx.lifecycle.l[] r5 = androidx.lifecycle.l.values()
            int r5 = r5.length
            int[] r5 = new int[r5]
            f1510a = r5
            r5[r0] = r1     // Catch:{ NoSuchFieldError -> 0x005f }
        L_0x005f:
            int[] r5 = f1510a     // Catch:{ NoSuchFieldError -> 0x0063 }
            r5[r2] = r0     // Catch:{ NoSuchFieldError -> 0x0063 }
        L_0x0063:
            int[] r0 = f1510a     // Catch:{ NoSuchFieldError -> 0x0067 }
            r0[r3] = r2     // Catch:{ NoSuchFieldError -> 0x0067 }
        L_0x0067:
            int[] r0 = f1510a     // Catch:{ NoSuchFieldError -> 0x006c }
            r2 = 0
            r0[r2] = r3     // Catch:{ NoSuchFieldError -> 0x006c }
        L_0x006c:
            int[] r0 = f1510a     // Catch:{ NoSuchFieldError -> 0x0070 }
