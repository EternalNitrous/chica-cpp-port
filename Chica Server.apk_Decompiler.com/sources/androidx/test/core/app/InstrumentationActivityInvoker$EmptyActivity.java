...
public class InstrumentationActivityInvoker$EmptyActivity extends Activity {
    ...
    public final BroadcastReceiver f1617d = new BroadcastReceiver() {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        registerReceiver(this.f1617d, new IntentFilter("androidx.test.core.app.InstrumentationActivityInvoker.FINISH_EMPTY_ACTIVITIES"));
        overridePendingTransition(0, 0);
    }
