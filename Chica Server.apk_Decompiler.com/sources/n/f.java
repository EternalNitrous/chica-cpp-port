...
public final class f extends e {
    ...
    public ArrayList f5453d0 = new ArrayList();

    /* renamed from: e0  reason: collision with root package name */
    public final d f5454e0 = new d(this);

    /* renamed from: f0  reason: collision with root package name */
    public final e f5455f0 = new e(this);

    /* renamed from: g0  reason: collision with root package name */
    public p.e f5456g0 = null;

    /* renamed from: h0  reason: collision with root package name */
    public boolean f5457h0 = false;

    /* renamed from: i0  reason: collision with root package name */
    public final m.e f5458i0 = new m.e();
    ...
    public int f5461l0 = 0;

    /* renamed from: m0  reason: collision with root package name */
    public int f5462m0 = 0;

    /* renamed from: n0  reason: collision with root package name */
    public b[] f5463n0 = new b[4];

    /* renamed from: o0  reason: collision with root package name */
    public b[] f5464o0 = new b[4];

    /* renamed from: p0  reason: collision with root package name */
    public int f5465p0 = 263;

    /* renamed from: q0  reason: collision with root package name */
    public boolean f5466q0 = false;

    /* renamed from: r0  reason: collision with root package name */
    public boolean f5467r0 = false;

    public final void B(e eVar, int i5) {
        if (i5 == 0) {
            int i6 = this.f5461l0 + 1;
            b[] bVarArr = this.f5464o0;
            if (i6 >= bVarArr.length) {
                this.f5464o0 = (b[]) Arrays.copyOf(bVarArr, bVarArr.length * 2);
            }
            b[] bVarArr2 = this.f5464o0;
            int i7 = this.f5461l0;
            bVarArr2[i7] = new b(eVar, 0, this.f5457h0);
            this.f5461l0 = i7 + 1;
        } else if (i5 == 1) {
            int i8 = this.f5462m0 + 1;
            b[] bVarArr3 = this.f5463n0;
            if (i8 >= bVarArr3.length) {
                this.f5463n0 = (b[]) Arrays.copyOf(bVarArr3, bVarArr3.length * 2);
            }
            b[] bVarArr4 = this.f5463n0;
            int i9 = this.f5462m0;
            bVarArr4[i9] = new b(eVar, 1, this.f5457h0);
            this.f5462m0 = i9 + 1;
        }
    }
    ...
    public final void C(m.e eVar) {
        ...
        boolean z6;
        b(eVar);
        int size = this.f5453d0.size();
        boolean z7 = false;
        for (int i5 = 0; i5 < size; i5++) {
            e eVar2 = (e) this.f5453d0.get(i5);
        ...
        if (z7) {
            for (int i6 = 0; i6 < size; i6++) {
                e eVar3 = (e) this.f5453d0.get(i6);
                if (eVar3 instanceof a) {
                    a aVar = (a) eVar3;
                    for (int i7 = 0; i7 < aVar.f5511e0; i7++) {
                        e eVar4 = aVar.f5510d0[i7];
                        int i8 = aVar.f5390f0;
                        if (i8 == 0 || i8 == 1) {
                            eVar4.H[0] = true;
                        } else if (i8 == 2 || i8 == 3) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            e eVar6 = (e) this.f5453d0.get(i10);
            if (eVar6 instanceof f) {
                int[] iArr = eVar6.f5430c0;
                int i11 = iArr[0];
                int i12 = iArr[1];
                if (i11 == 2) {
                    eVar6.w(1);
                ...
                eVar6.f5435h = -1;
                eVar6.f5436i = -1;
                int[] iArr2 = this.f5430c0;
                int i13 = iArr2[0];
                int[] iArr3 = eVar6.f5430c0;
                if (i13 != 2 && iArr3[0] == 4) {
                    d dVar = eVar6.f5450x;
                    int i14 = dVar.f5422e;
                    int l = l();
                    d dVar2 = eVar6.f5452z;
                    int i15 = l - dVar2.f5422e;
                    dVar.f5424g = eVar.k(dVar);
                    dVar2.f5424g = eVar.k(dVar2);
                    eVar.d(dVar.f5424g, i14);
                    eVar.d(dVar2.f5424g, i15);
                    eVar6.f5435h = 2;
                    eVar6.N = i14;
                    int i16 = i15 - i14;
                    eVar6.J = i16;
                ...
                if (iArr2[1] != 2 && iArr3[1] == 4) {
                    d dVar3 = eVar6.f5451y;
                    int i18 = dVar3.f5422e;
                    int j5 = j();
                    d dVar4 = eVar6.A;
                    int i19 = j5 - dVar4.f5422e;
                    dVar3.f5424g = eVar.k(dVar3);
                    dVar4.f5424g = eVar.k(dVar4);
                    eVar.d(dVar3.f5424g, i18);
                    eVar.d(dVar4.f5424g, i19);
                    if (eVar6.P > 0 || eVar6.V == 8) {
                        d dVar5 = eVar6.B;
                        k k5 = eVar.k(dVar5);
                        dVar5.f5424g = k5;
                        eVar.d(k5, eVar6.P + i18);
                    }
                    eVar6.f5436i = 2;
                    eVar6.O = i18;
                    int i20 = i19 - i18;
    ...
    public final boolean D(int r18, boolean r19) {
        /*
            ...
            int r9 = r5.m()
            int r10 = r5.n()
            java.util.ArrayList r11 = r4.f5571e
            o.j r12 = r5.f5431d
            o.l r13 = r5.f5432e
        ...
        L_0x0100:
            ...
            goto L_0x0111
        L_0x0107:
            boolean r10 = r4 instanceof o.c
            if (r10 != 0) goto L_0x00e1
            o.g r4 = r4.f5595e
            boolean r4 = r4.f5584j
        ...
        L_0x0114:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: n.f.D(int, boolean):boolean");
    }
    ...
    public final void E() {
        ...
        L_0x0046:
            ...
            r8 = r7[r6]
            r9 = r7[r2]
            java.util.ArrayList r10 = r1.f5453d0
            r11 = 2
        ...
        L_0x0060:
            ...
            java.util.ArrayList r14 = r1.f5453d0
            java.lang.Object r14 = r14.get(r0)
            n.e r14 = (n.e) r14
            boolean r15 = r14 instanceof n.f
        ...
        L_0x0079:
            ...
            r6 = 0
            r1.f5461l0 = r6     // Catch:{ Exception -> 0x0220 }
            r1.f5462m0 = r6     // Catch:{ Exception -> 0x0220 }
            r1.g(r5)     // Catch:{ Exception -> 0x0220 }
            r0 = 0
        L_0x008b:
            if (r0 >= r13) goto L_0x009b
            java.util.ArrayList r6 = r1.f5453d0     // Catch:{ Exception -> 0x0220 }
            java.lang.Object r6 = r6.get(r0)     // Catch:{ Exception -> 0x0220 }
            n.e r6 = (n.e) r6     // Catch:{ Exception -> 0x0220 }
            r6.g(r5)     // Catch:{ Exception -> 0x0220 }
            int r0 = r0 + 1
            goto L_0x008b
        L_0x009b:
            r1.C(r5)     // Catch:{ Exception -> 0x0220 }
            m.i r0 = r5.f5299b     // Catch:{ Exception -> 0x0211 }
            boolean r6 = r5.f5303f     // Catch:{ Exception -> 0x0211 }
            if (r6 == 0) goto L_0x00da
            r6 = 0
        L_0x00a5:
            int r14 = r5.f5306i     // Catch:{ Exception -> 0x0211 }
            if (r6 >= r14) goto L_0x00b6
            m.c[] r14 = r5.f5302e     // Catch:{ Exception -> 0x0211 }
            r14 = r14[r6]     // Catch:{ Exception -> 0x0211 }
            boolean r14 = r14.f5295e     // Catch:{ Exception -> 0x0211 }
        ...
        L_0x00ba:
            r0 = 0
        L_0x00bb:
            int r6 = r5.f5306i     // Catch:{ Exception -> 0x0211 }
            if (r0 >= r6) goto L_0x00cc
            m.c[] r6 = r5.f5302e     // Catch:{ Exception -> 0x0211 }
            r6 = r6[r0]     // Catch:{ Exception -> 0x0211 }
            m.k r11 = r6.f5291a     // Catch:{ Exception -> 0x0211 }
            float r6 = r6.f5292b     // Catch:{ Exception -> 0x0211 }
            r11.f5326e = r6     // Catch:{ Exception -> 0x0211 }
            int r0 = r0 + 1
            goto L_0x00bb
        L_0x00cc:
            r25 = r3
        ...
        L_0x00db:
            ...
            m.c[] r14 = r5.f5302e     // Catch:{ Exception -> 0x0105 }
            r14 = r14[r6]     // Catch:{ Exception -> 0x0105 }
            r18 = r15
            m.k r15 = r14.f5291a     // Catch:{ Exception -> 0x0100 }
            int r15 = r15.l     // Catch:{ Exception -> 0x0100 }
            r19 = r10
            r10 = 1
            if (r15 != r10) goto L_0x00f1
            goto L_0x00f9
        L_0x00f1:
            float r10 = r14.f5292b     // Catch:{ Exception -> 0x01b2 }
        ...
        L_0x0115:
            ...
            r22 = -1
        L_0x0126:
            int r15 = r5.f5306i     // Catch:{ Exception -> 0x01b2 }
            if (r14 >= r15) goto L_0x01b8
            m.c[] r15 = r5.f5302e     // Catch:{ Exception -> 0x01b2 }
            r15 = r15[r14]     // Catch:{ Exception -> 0x01b2 }
            r24 = r4
            m.k r4 = r15.f5291a     // Catch:{ Exception -> 0x01ae }
            int r4 = r4.l     // Catch:{ Exception -> 0x01ae }
            r25 = r3
            r3 = 1
        ...
        L_0x0139:
            goto L_0x019e
        L_0x013b:
            boolean r3 = r15.f5295e     // Catch:{ Exception -> 0x0195 }
            if (r3 == 0) goto L_0x0140
            goto L_0x0139
        L_0x0140:
            float r3 = r15.f5292b     // Catch:{ Exception -> 0x0195 }
            int r3 = (r3 > r17 ? 1 : (r3 == r17 ? 0 : -1))
            if (r3 >= 0) goto L_0x019e
            r3 = 1
        L_0x0147:
            int r4 = r5.f5305h     // Catch:{ Exception -> 0x0195 }
            if (r3 >= r4) goto L_0x019c
            java.lang.Object r4 = r11.f4453d     // Catch:{ Exception -> 0x0195 }
            m.k[] r4 = (m.k[]) r4     // Catch:{ Exception -> 0x0195 }
            r4 = r4[r3]     // Catch:{ Exception -> 0x0195 }
            r26 = r6
            m.b r6 = r15.f5294d     // Catch:{ Exception -> 0x0195 }
            float r6 = r6.g(r4)     // Catch:{ Exception -> 0x0195 }
        ...
        L_0x016b:
            ...
            float[] r7 = r4.f5328g     // Catch:{ Exception -> 0x0186 }
        ...
        L_0x01b8:
            ...
            m.c[] r4 = r5.f5302e     // Catch:{ Exception -> 0x0186 }
            r4 = r4[r6]     // Catch:{ Exception -> 0x0186 }
            m.k r7 = r4.f5291a     // Catch:{ Exception -> 0x0186 }
            r7.f5324c = r3     // Catch:{ Exception -> 0x0186 }
            java.lang.Object r3 = r11.f4453d     // Catch:{ Exception -> 0x0186 }
            m.k[] r3 = (m.k[]) r3     // Catch:{ Exception -> 0x0186 }
            r3 = r3[r22]     // Catch:{ Exception -> 0x0186 }
            r4.f(r3)     // Catch:{ Exception -> 0x0186 }
            m.k r3 = r4.f5291a     // Catch:{ Exception -> 0x0186 }
            r3.f5324c = r6     // Catch:{ Exception -> 0x0186 }
            r3.d(r4)     // Catch:{ Exception -> 0x0186 }
            goto L_0x01de
        L_0x01dc:
            r21 = 1
        L_0x01de:
            int r3 = r5.f5305h     // Catch:{ Exception -> 0x0186 }
            r4 = 2
            int r3 = r3 / r4
        ...
        L_0x01f2:
            ...
            r0 = 0
        L_0x01fe:
            int r3 = r5.f5306i     // Catch:{ Exception -> 0x0186 }
            if (r0 >= r3) goto L_0x020f
            m.c[] r3 = r5.f5302e     // Catch:{ Exception -> 0x0186 }
            r3 = r3[r0]     // Catch:{ Exception -> 0x0186 }
            m.k r4 = r3.f5291a     // Catch:{ Exception -> 0x0186 }
            float r3 = r3.f5292b     // Catch:{ Exception -> 0x0186 }
            r4.f5326e = r3     // Catch:{ Exception -> 0x0186 }
            int r0 = r0 + 1
            goto L_0x01fe
        L_0x020f:
            r14 = 1
        ...
        L_0x022d:
            ...
            r3.println(r0)
        L_0x0243:
            boolean[] r0 = a2.d5.f73a
            if (r14 == 0) goto L_0x0265
            r3 = 2
            r4 = 0
            r0[r3] = r4
            r1.A(r5)
            java.util.ArrayList r3 = r1.f5453d0
            int r3 = r3.size()
            r4 = 0
        L_0x0255:
            if (r4 >= r3) goto L_0x0279
            java.util.ArrayList r6 = r1.f5453d0
