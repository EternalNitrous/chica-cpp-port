...
public final class c extends y4 {
    ...
    public final /* synthetic */ BottomSheetBehavior f5622a;

    public c(BottomSheetBehavior bottomSheetBehavior) {
        this.f5622a = bottomSheetBehavior;
    }
    ...
    public final int b(View view, int i5) {
        return r8.a(i5, this.f5622a.w(), d());
    }

    public final int d() {
        BottomSheetBehavior bottomSheetBehavior = this.f5622a;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x006d, code lost:
        if (java.lang.Math.abs(r5.getTop() - r3.w()) < java.lang.Math.abs(r5.getTop() - r3.E)) goto L_0x00c4;
     */
    ...
    public final void h(android.view.View r5, float r6, float r7) {
        /*
            ...
            r2 = 1
            com.google.android.material.bottomsheet.BottomSheetBehavior r3 = r4.f5622a
            if (r1 >= 0) goto L_0x001b
            boolean r6 = r3.f3477b
        ...
        L_0x00d8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: o2.c.h(android.view.View, float, float):void");
    }

    public final boolean i(View view, int i5) {
        BottomSheetBehavior bottomSheetBehavior = this.f5622a;
        int i6 = bottomSheetBehavior.L;
        if (i6 == 1 || bottomSheetBehavior.f3476a0) {
            return false;
        }
