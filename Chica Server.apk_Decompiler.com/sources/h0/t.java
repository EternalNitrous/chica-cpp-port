...
public final class t implements ActionMode.Callback {
    ...
    public final ActionMode.Callback f4977a;
    ...
    public t(ActionMode.Callback callback, TextView textView) {
        this.f4977a = callback;
        this.f4978b = textView;
    }

    public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f4977a.onActionItemClicked(actionMode, menuItem);
    }

    public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f4977a.onCreateActionMode(actionMode, menu);
    }

    public final void onDestroyActionMode(ActionMode actionMode) {
        this.f4977a.onDestroyActionMode(actionMode);
    }
    ...
    public final boolean onPrepareActionMode(android.view.ActionMode r14, android.view.Menu r15) {
        /*
            r13 = this;
            android.widget.TextView r0 = r13.f4978b
            android.content.Context r1 = r0.getContext()
            android.content.pm.PackageManager r2 = r1.getPackageManager()
            boolean r3 = r13.f4982f
            r4 = 1
            ...
            r13.f4979c = r3     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            ...
            r13.f4980d = r3     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            r13.f4981e = r4     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            goto L_0x0032
        L_0x002b:
            r3 = 0
            r13.f4979c = r3
            ...
            r13.f4981e = r6
        L_0x0032:
            boolean r3 = r13.f4981e     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0127 }
            if (r3 == 0) goto L_0x0041
            java.lang.Class r3 = r13.f4979c     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0127 }
            boolean r3 = r3.isInstance(r15)     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0127 }
            if (r3 == 0) goto L_0x0041
            java.lang.reflect.Method r3 = r13.f4980d     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0127 }
            goto L_0x004f
        L_0x0041:
        ...
        L_0x010c:
            ...
            goto L_0x00d6
        L_0x0127:
            android.view.ActionMode$Callback r0 = r13.f4977a
            boolean r14 = r0.onPrepareActionMode(r14, r15)
            return r14
        */
        throw new UnsupportedOperationException("Method not decompiled: h0.t.onPrepareActionMode(android.view.ActionMode, android.view.Menu):boolean");
    }
}
